...
<TD ALIGN="CENTER" VALIGN="BOTTOM" CLASS="style2cc"><IMG SRC="pictures/shim.gif" WIDTH="265" HEIGHT="1"><br><SPAN CLASS="style1b">#trim(author)#</SPAN><BR><A HREF="#link#" TARGET="_blank"><IMG SRC="pictures/outlink.gif" WIDTH="13" HEIGHT="10" BORDER="0" ALIGN="ABSMIDDLE"></A> <SPAN CLASS="style1b"><EM>#Ucase(company)#&nbsp;</EM></SPAN><SPAN CLASS="style27">#REReplace(author.city,"[0-9]","","ALL")# - #Ucase(author.country)# - #dateformat(datetime,"m/YYYY")#</SPAN></TD>
...
<TR>
<TD ALIGN="center" VALIGN="buttom" CLASS="style2"><SPAN CLASS="style2cfade">Frank Rothkamm <EM>#album#</EM></SPAN></TD>
</TR>
<TR>
<TD COLSPAN="2" CLASS="style1Trans"><br><SPAN CLASS="style5">"</SPAN><BR>
<SPAN CLASS="style3">#REReplace(text,Chr(10),'<br><br>','ALL')#</SPAN><br>

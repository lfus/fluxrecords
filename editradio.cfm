...
<CFUPDATE DATASOURCE="#ds#" TABLENAME="radio">
</CFIF>
<CFIF FindNoCase(Trim(submit),'add')> 
<CFINSERT DATASOURCE="#ds#" TABLENAME="radio">
</CFIF>
</CFIF>
...
<TR>
  ...
  <TD CLASS="style3b">DJ<BR><INPUT NAME="DJ" TYPE="text" CLASS="style2" VALUE=""></TD>
  <TD CLASS="style3b">station<BR><INPUT NAME="station" TYPE="text" CLASS="style2" VALUE=""></TD>
  <TD CLASS="style3b">link<BR><INPUT NAME="link" TYPE="text" CLASS="style2" VALUE=""></TD>
  <TD CLASS="style3b">datetime<BR><INPUT NAME="datetime" TYPE="text" CLASS="style2" VALUE="#DateFormat(now(),'yyyy-m-d')#"></TD>
  <TD CLASS="style3b">show<BR><INPUT NAME="media" TYPE="text" CLASS="style2" VALUE=""></TD>
...
<TR>
  ...
  <TD CLASS="style3b">DJ<BR><INPUT NAME="DJ" TYPE="text" CLASS="style2" VALUE="#Trim(DJ)#"></TD>
  <TD CLASS="style3b">station<BR><INPUT NAME="station" TYPE="text" CLASS="style2" VALUE="#Trim(station)#"></TD>
  ...
  <TD CLASS="style3b">show<BR><INPUT NAME="media" TYPE="text" CLASS="style2" VALUE="#Trim(media)#"></TD>

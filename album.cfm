...
<HEAD>
<TITLE><CFOUTPUT>#album.Artist# - #album.Name# #album.NameExt#</CFOUTPUT></TITLE>
...
if (locMP3 EQ "") msg = "[file missing]" 
		...
		{
			title:'<cfoutput><b>[#currentrow#]</b/> #REReplace(tracks.name,"(#chr(10)#|#chr(13)#|')"," ","ALL")# (#Evaluate(int(tracks.length/60))#:#NumberFormat(Evaluate(tracks.length mod 60),'00')#) opus #tracks.ID# (#year#) #msg# <a href="work.cfm?opus=#tracks.ID#" target="_blank"><img src="pictures/download_3.gif" border=0 WIDTH="20" hspace=20" align="middle"></a></cfoutput>',
...
<meta name="title" content="<cfoutput>#album.Name# #album.NameExt# (#DateFormat(album.Released,'YYYY')#</cfoutput>)">
<meta property="og:title" content="<cfoutput>#album.Name# #album.NameExt# (#DateFormat(album.Released,'YYYY')#</cfoutput>)">
<meta property="og:type" content="album">
<meta property="og:site_name" content="Frank Rothkamm">
<meta property="og:description" content="Album by <cfoutput>#album.Artist#</cfoutput> (sound artist) <cfoutput>#album.VisualArt#</cfoutput> (visual artist) ">
...
<meta name="twitter:title" content="<cfoutput>#album.Name# #album.NameExt# (#DateFormat(album.Released,'YYYY')#</cfoutput>)">
<meta name="twitter:description" content="Album by <cfoutput>#album.Artist#</cfoutput> (sound artist) <cfoutput>#album.VisualArt#</cfoutput> (visual artist) ">
...
<!--- Album Cover --->
<TR>
<TD VALIGN="MIDDLE" WIDTH="168" ALIGN="CENTER"><CFIF NOT Len(LastAlbum.Name) LT 1><A HREF="album.cfm?<cfoutput>#Replace(LastAlbum.Name,' ','-','ALL')#</cfoutput>"><IMG SRC="pictures/back.gif" ALT="last album" WIDTH="16" HEIGHT="16" BORDER="0"></A><CFELSE><IMG SRC="pictures/shim.gif" HEIGHT="16" WIDTH="16"></CFIF></TD>

<TD><CFIF FileExists('#GetDirectoryFromPath(ExpandPath("*.*"))#/pictures/albumcover/small/#trim(album.Artist)#-#trim(album.Name)#.jpg')><cfoutput><A HREF="pictures/albumcover/#trim(album.Artist)#-#trim(album.Name)#.jpg" target="_blank"><IMG  SRC="pictures/albumcover/small/#album.Artist#-#trim(album.Name)#.jpg"  BORDER="0" name='SlideShow' title='[Object] "#album.Artist#-#trim(general.Name)#'></A></cfoutput><CFELSE><IMG SRC="pictures/albumcover/small/generic.jpg" name='SlideShow' ALIGN="TOP" ></CFIF></TD>

<TD VALIGN="MIDDLE" ALIGN="CENTER" WIDTH="165" ><CFIF NOT Len(NextAlbum.Name) LT 1><A HREF="album.cfm?<cfoutput>#Replace(NextAlbum.Name,' ','-','ALL')#</cfoutput>"><IMG SRC="pictures/forward.gif" ALT="next album" WIDTH="16" HEIGHT="16" BORDER="0"></A><CFELSE><IMG SRC="pictures/shim.gif" HEIGHT="16" WIDTH="16"></CFIF></TD>
...
<CFSET AlbumIcon = 'pictures/icons/generic.jpg' >
   ...
   <TR>
      ...
      <TD VALIGN="TOP">#Replace(album.VisualArt,",","<br>","ALL")#</TD>
   </TR>
   </CFIF>

...
<TR>
  ...
  <TD CLASS="style3b">date<BR><INPUT NAME="datetime" TYPE="text" CLASS="style2" VALUE="#DateFormat(now(),'yyyy-m-d')#"></TD>
  <TD CLASS="style3b">media<BR><INPUT NAME="media" TYPE="text" CLASS="style2" VALUE=""></TD>
  <TD CLASS="style3b">rank<BR><INPUT NAME="rank" TYPE="text" CLASS="style2" VALUE=""></TD>
  <TD CLASS="style3b">album<BR><INPUT NAME="album" TYPE="text" CLASS="style2" VALUE=""></TD>
</TR>
<TR>
<TD COLSPAN="8" CLASS="style3b">tagline<TEXTAREA NAME="tagline" COLS="120" ROWS="1" CLASS="style2"></TEXTAREA></TD>
</TR>
<TR>
<TD COLSPAN="8"><TEXTAREA NAME="Text" COLS="90" ROWS="20" CLASS="style1"></TEXTAREA></TD>
</TR>

<TR>
<TD COLSPAN="8" ALIGN="CENTER"><INPUT NAME="submit" TYPE="submit" CLASS="style2b" VALUE="add" WIDTH="50"><BR><BR></TD>
</TR>
...
<CFOUTPUT QUERY="all">
<FORM ACTION="#script_name#?#CGI.QUERY_STRING#" METHOD="post">
<TR>
  ...
  <TD CLASS="style3b">datetime<BR><INPUT NAME="datetime" TYPE="text" CLASS="style2" VALUE="#DateFormat(datetime,'yyyy-m-d')#"></TD>
  <TD CLASS="style3b">media<BR><INPUT NAME="media" TYPE="text" CLASS="style2" VALUE="#Trim(media)#"></TD>
  <TD CLASS="style3b">rank<BR><INPUT NAME="rank" TYPE="text" CLASS="style2" VALUE="#Trim(rank)#"></TD>
...
<TR>
<TD COLSPAN="8" CLASS="style3b">tagline<TEXTAREA NAME="tagline" COLS="120" ROWS="1" CLASS="style2">#Trim(tagline)#</TEXTAREA></TD>
</TR>

<TR>
<TD COLSPAN="8"><TEXTAREA NAME="Text" COLS="90" ROWS="20" CLASS="style1">#Trim(Text)#</TEXTAREA></TD>
</TR>

<TR>
<TD COLSPAN="8" ALIGN="CENTER"><INPUT NAME="submit" TYPE="submit" CLASS="style2b" VALUE="save" ><BR><BR></TD>
</TR>
